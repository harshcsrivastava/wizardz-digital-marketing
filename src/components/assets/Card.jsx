...
function Card({
  line_one = "Search engine",
  line_two = "optimization",
  ...
  return (
    <>
      <div
        className={`left border-2 rounded-3xl overflow-hidden p-8 md:min-w-[calc(50%-12px)] flex gap-2 items-center justify-between ${
